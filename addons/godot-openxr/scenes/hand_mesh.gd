...
@export (MOTION_RANGE) var motion_range : set = set_motion_range
@export (Texture2D) var albedo_texture : set = set_albedo_texture
@export (Texture2D) var normal_texture : set = set_normal_texture
